    ...
    <AppLayout>
      <div className="pb-12">
        ...
        <motion.div
          ...
          className="pt-2 pb-8 text-center lg:text-left lg:flex lg:items-center lg:gap-5"
        >
          <div className="mx-auto lg:mx-0 mb-4 lg:mb-0 w-16 h-16 rounded-2xl gradient-sky flex items-center justify-center shadow-glow-blue shrink-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-5 space-y-5">
            ...
            <motion.section
              ...
              className="glass-elevated rounded-2xl p-5 lg:p-6 shadow-card"
            >
            ...
            {error && (
              <motion.p
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="text-sm text-destructive px-1 flex items-center gap-1.5"
              >
            ...
            <Button onClick={calculate} size="lg"
              className="w-full h-14 text-base font-bold gradient-sky text-primary-foreground rounded-2xl shadow-glow-blue hover:shadow-elevated transition-all"
            >
          ...
          <div className="lg:col-span-7">
            <AnimatePresence>
              {result ? (
                ...
                >
                  {/* Status Banner */}
                  <div className={`rounded-2xl p-5 lg:p-6 border-2 shadow-card ${
                    ...
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div>
                        <p className={`text-lg lg:text-xl font-extrabold ${result.overallCompliant ? 'text-success' : 'text-destructive'}`}>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="glass-elevated rounded-2xl p-5 shadow-card">
                      ...
                      <p className={`text-3xl lg:text-4xl font-extrabold font-mono ${result.dutyWithinLimit ? 'text-foreground' : 'text-destructive'}`}>
                        {result.dutyHours}h
                      </p>
                    ...
                    <div className="glass-elevated rounded-2xl p-5 shadow-card">
                      ...
                      <p className={`text-3xl lg:text-4xl font-extrabold font-mono ${result.flightWithinLimit ? 'text-foreground' : 'text-destructive'}`}>
                  ...
                  <div className="glass rounded-2xl px-5 py-4 flex items-center justify-between shadow-card">
                    ...
                    <p className="text-2xl lg:text-3xl font-extrabold font-mono text-foreground">{result.endOfDutyTime}</p>
                  </div>
                ...
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  className="hidden lg:flex flex-col items-center justify-center h-full min-h-[400px] glass rounded-2xl p-10 text-center"
                >
                  <div className="w-20 h-20 rounded-3xl bg-primary/10 flex items-center justify-center mb-6">
                    <Gauge className="w-10 h-10 text-primary/40" />
                  </div>
                  <h3 className="text-lg font-bold text-foreground/60 mb-2">Resultado aparecerá aqui</h3>
                  <p className="text-sm text-muted-foreground/60 max-w-xs">
                    Preencha os dados da operação e clique em "Calcular Jornada" para ver o resultado completo com memória de cálculo.
                  </p>
                </motion.div>
              )}
            </AnimatePresence>
